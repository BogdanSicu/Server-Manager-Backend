package com.example.Server.Manager.controllers;

import com.example.Server.Manager.enums.Status;
import com.example.Server.Manager.models.Response;
import com.example.Server.Manager.models.Server;
import com.example.Server.Manager.services.implementations.ServerServiceImplementation;
...
public class ServerController {
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(System.getProperty("user.home") + "/Downloads/Poze_Server/" + fileName));
    }
